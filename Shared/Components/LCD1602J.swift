...
/// A class wrapping state and functionality needed to drive the LCD module included with the SwiftIO MakerKit.
/// - Note: Original source from MadMachine MakerKit project sources.
public final class LCD1602J {
